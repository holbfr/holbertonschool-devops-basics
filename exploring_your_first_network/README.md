...
- **[What is an IP address?](https://www.cloudflare.com/learning/network-layer/what-is-an-ip-address/)** - Introductory explanation of IPv4 and IPv6.
- **[What is DNS?](https://www.cloudflare.com/learning/dns/what-is-dns/)** - Introductory explanation of name resolution.
- **[IPv6 Addresses Explained](https://www.youtube.com/watch?v=irhS0ASkvy8)** - Introduction to IPv6 and address-space limitations in IPv4.
- **[Linux `ip` manual page](https://man7.org/linux/man-pages/man8/ip.8.html)** - Reference for interfaces, addresses, routes, and neighbors.
- **[Linux `ss` manual page](https://man7.org/linux/man-pages/man8/ss.8.html)** - Reference for socket inspection.
